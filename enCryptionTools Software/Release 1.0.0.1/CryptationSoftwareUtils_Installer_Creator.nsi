Name "Cryptation Software Utils"

!define INSTALLER_NAME "Cryptation Software Utils"

!include "MUI2.nsh"

!define MUI_ICON "Utils/AppIco.ico"

!define MUI_WELCOMEPAGE_TITLE "Cryptation Software Utils Install Version 1.0.0.1."
...
VIAddVersionKey ProductName "Cryptation Software"
...
InstallDir "$PROGRAMFILES\CryptationSoftwareUtils"

Section "install"
SetOutPath "$INSTDIR"
File /r "Utils"
File "Files\ControlCenter.exe"
File "Files\CryptationSoftware.exe"
File "Files\Microsoft.Win32.TaskScheduler.dll"
File "Files\Microsoft.Win32.TaskScheduler.xml"

writeUninstaller "Uninstall.exe"

CreateShortCut "$DESKTOP\Cryptation Software Utils Control Center.lnk" "$INSTDIR\ControlCenter.exe" ""
